...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        //TODO: Recupero el valor del EditText i l'envio a l'activitat 2

        String nom = editText1.getText().toString();
        int edat = Integer.parseInt(editText2.getText().toString());

        Intent intent = new Intent(this,Activity2.class);
        //intent.putExtra("etiquetaNom",nom); //"etiquetaNom" es la etiqueta
